...
if(isset($_POST["ok"]))
		{ 
				...
				if(mysqli_query($conn,$sql))
					{
						header("location:hall3.php?msg=Your Programme Reservation is Successfully ! Thank you ");
		//echo "hi";
				...
				<div class="booking-form" style="width:500px; background-color:#031a34;">
					<div  style="width:400px; background-color:white;">
						...
						<form action="hall3.php" autocomplete="off" method="POST">
							...
							&nbsp  &nbsp	<b><input class="" type="NIC No" value="03" name="hallno"  style="width:40px; border:none; font-size:20px;"></b>
							</div> 
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
							...
							<div class="form-group">
								...
								<input class="form-control" name="add"  type="tel" placeholder="Enter Institute number">
							</div>
