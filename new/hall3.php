...
if(isset($_POST["ok"]))
		{ 
				...
				$date=$_POST["date"];
					...
					$sql = "INSERT INTO booking_details(nic_no,tele_no,name,address,reason,date) 
							VALUES('$nicno','$tpno','$name','$add','$reason','$date');";
	...
	<div class="row">
        <div class="col-md-12">
				<?php
					...
					$sql_accna="SELECT * FROM hall_booking where hall_no=3";
...
<div class="row">
	...
	&nbsp &nbsp 	<input type="submit" class="btn btn-sm btn-primary" name="find" value=" Booking" style="height:30px;"  data-title="Delete" data-toggle="modal" data-target="#delete" >
	</div>
</div>
...
<form action="hall3.php" autocomplete="off" method="POST">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="row">
						...
						<input type="text" class="form-control" placeholder="NIC:No" name="hallno" required value="3" style="width:40px;"></label>
