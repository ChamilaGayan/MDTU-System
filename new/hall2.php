	...
	<div class="row">
        <div class="col-md-12">
				<?php
					...
					$sql_accna="SELECT * FROM hall_booking where hall_no=2";
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="row">
						...
						<input type="text" class="form-control" placeholder="NIC:No" name="hallno" required value="2" style="width:40px;"></label>
