...
<!--         <ol>
	...
	<form action="catch1.php" method="POST">
		...
		<div class="row" style="background-color:white;">
			<center><img src="assets/img/gov.jpg" width="50px" height="auto"></center>
			<center><label for="staticEmail" class="col-sm-5 col-form-label" style="font-size:20px;"><b>මාතලේ දිස්ත්‍රික් ලේකම් කාර්යාලය , කළමනාකරන සංවර්ධන හා පුහුණු ආයතනය (MDTU) පුහුණුවීම් සඳහා අයදුම් පත්‍රය - 2020/2021</b></label></br></center>
				<div class="col-2" ></div>
					<div class="col-8" style="background-color:#64bdfc;">
						...
						<input disabled type="text" class="form-control" placeholder="සේවා කාලය " name="year" style="width:130px;text-align:left;" required value=<?php echo "'" . $row["tp_no"] . "'" ?> >
						...
						<textarea  disabled style=" height:100px;" class="form-control" placeholder="විෂය පථයට අඳාළ රාජකාරී  " name="discrip" required><?php echo  $row["tp_no"] ?></textarea>
...
<!-----------------------------------------------------------------------persional Details table-------------------------------------------------------------------------->	
						...
						<input disabled  type="text" class="form-control" placeholder="ලිපිනය" name="paddress" required value=<?php echo "'" . $row["tp_no"] . "'" ?> >
						  
						  
						<label for="staticEmail" class="col-sm-5 col-form-label" style="text-align:left;"><b> ජංගම/නිවස :- </b> </label>
						<input disabled type="text" class="form-control" placeholder="ජංගම/නිවස " name="ptpno" style="width:130px;" required value=<?php echo "'" . $row["tp_no"] . "'" ?> >
...
<!-----------------------------------------------------------------completed courses table---------------------------------------------------------------------------------->
		...
		<div class="input_fields_wrap">
				<div class="row">
					<div class="col-5">
						<label for="staticEmail" class="col-sm-5 col-form-label" style="text-align:left;">පාඨමාලාවේ නම </label>
							<?php
								$conn=mysqli_connect('localhost','root','','mydb');
								$conn->set_charset("utf8");
							?>
						...
						<div class="col-2">
						<label for="staticEmail" class="col-sm-5 col-form-label" style="text-align:left;">වර්ෂය </label>
							...
							<div class="col-4">
								<label for="staticEmail" class="col-sm-5 col-form-label" style="text-align:left;">පැවැත්වූ දිනය</label> 
								<input disabled type="date" name="comdate[]" class="form-control"  required value=<?php echo "'" . $row["completed_date"] . "'" ?> >    
							</div>
							
					<div class="col-1">
						 <label type="hidden" for="staticEmail" class="col-sm-5 col-form-label" style="text-align:left;"><button class="button" style="border:none; background-color:#64bdfc; height:25px;"></button></label> 
