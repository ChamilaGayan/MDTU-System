...
if(isset($_SESSION["username"]))
{
	...
	$sql_getData = "SELECT * from user,trainee,request_courses,completed_course,institute,courses WHERE user.user_name=trainee.t_id AND user.user_name=request_courses.t_id AND user.user_name=institute.t_id AND user.user_name=completed_course.t_id AND courses.course_code=request_courses.course_code1 AND user.user_name='$uname' GROUP BY courses.course_code";
	// echo $sql_getData; 
...
<!-----------------------------------------------------------------request courses table----------------------------------------------------------->		
						...
						<?php
								echo "<input  disabled class='form-control' type='text' value='" . $row["course_name"] . "' required><br>";
										while($rowa = $result->fetch_assoc())
										{
											echo "<input  disabled class='form-control' type='text' value='" . $rowa["course_name"] . "' required><br>";
										}
						?>
...
<label for="staticEmail" class="col-sm-10 col-form-label" style="text-align:left;"><b>04.එම වැඩසටහන් සඳහා පසුගිය වසර දෙක තුළ සහභාගී වූයේ නම් ඒ පිළිබඳ විස්තර.</b></label></br>
		<div class="input_fields_wrap">
				<div class="row">
					<?php
							echo "<input  disabled class='form-control' type='text' value='" . $row["course_name"] . "' required>";
							echo "<input  disabled class='form-control' type='text' value='" . $row["completed_year"] . "' required>";
							echo "<input  disabled class='form-control' type='text' value='" . $row["completed_date"] . "' required>";
								...
								while($rowaa = $result->fetch_assoc())
									{
										...
										<?php echo "<input  disabled class='form-control' type='text' value='" . $rowaa["course_name"] . "' required>"; ?>
										</div>

										<br>
										<div class="col-md-4 mb-3">
										<label for="staticEmail"  style="text-align:left;">වර්ෂය </label>
										<?php echo "<input  disabled class='form-control' type='text' value='" . $rowaa["completed_year"] . "' required>"; ?>
										</div>
										<br>
										<div class="col-md-4 mb-3">
										<label for="staticEmail"  style="text-align:left;">පැවැත්වූ දිනය</label>
										<?php echo "<input  disabled class='form-control' type='text' value='" . $rowaa["completed_date"] . "' required>"; ?>
										</div>
