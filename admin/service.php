...
<!-- add service-->
	<div class="row">
		<div class="col-md-4 mb-3">
			<label for="exampleInputPassword1">Add Service </label>
			<input type="text" class="form-control" id="exampleInputPassword1" placeholder="Type Service Name " name="addservice" required >
		</div>
	</div>
        ...
        <div class="col-md-10">
			...
			<tr>
				...
				<?php
					...
					$sql_accna="SELECT * FROM service order by service_no";
				...
				<?php 
					...
					while($row_accna=$accna_info->fetch_assoc()){?>
						...
						<td><?php echo $row_accna['service_no'];?></td>
						<td><?php echo $row_accna['service_name'];?></td>
