...
<!-- <input type="text" placeholder="Search.." name="search">-->
	...
	</br><!--<button id="button" class="btn btn-primary">Add</button>--></br>
...
if(isset($_POST["find"]))
{
	...
	if($rowcount > 0)
	{
		...
		echo "<table id='example' class='display' style='width:100%'><thead><tr><th style='width:20px;' >NO</th><th style='width:20px;'>Name</th><th style='width:20px;'>Tele:No</th><th style='width:20px;'>Position</th><th style='width:20px;'>Work Place</th><th>Duty</th></thead></tr>";
		
	//echo"hi";
		
		while($row=mysqli_fetch_assoc($result))
		{
			echo "<tr><tbody><td>" .++$i. "</td><td>" . $row["name"]. "</td><td>" . $row["email_address"]."</td><td>" . $row["position"]."</td><td>" . $row["office_name"]."</td><td>" . $row["duty"]. "</td></tbody><tr>";
		}
			echo "</table>";
	}
	else
