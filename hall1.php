				...
				<div class="row">
					...
					<div  style="width:400px; background-color:white;">
						...
						<form action="hall1.php" autocomplete="off" method="POST">
							...
							&nbsp  &nbsp	<b><input class="" type="NIC No" value="01" name="hallno"  style="width:40px; border:none; font-size:20px;"></b>
							</div> 
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										&nbsp <span class="form-label" style="color:gray;">Check In</span>
										<input class="form-control" type="text" name="indate" style="width:175px;" id="txtdate" placeholder="Check In Date" required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										&nbsp <span class="form-label" style="color:gray;">Check Out</span>
										<input class="form-control" type="text" name="outdate" style="width:175px;" id="txtdate1"  placeholder="Check Out Date" required>
									</div>
								</div>
							</div>
							<div class="row">
							...
							<div class="form-group">
								...
								<input class="form-control" type="tel" name="tpno" maxlength="10"  style="width:150px;" placeholder=" Phone Number">
							</div>
